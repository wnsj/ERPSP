...
public class WebSocketController {
    ...
    public JSONObject sendMessage(String accountId, String message, String url) throws Exception {
        ...
        if (StringUtils.isNotBlank(url)) context.put("url", url);
        else context.put("url", "http://www.baidu.com");
